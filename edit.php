...
$country  = mysqli_query($connection, "SELECT DISTINCT foglalas FROM tbl_insert");

if(count($_POST)>0)
{
    mysqli_query($connection,"UPDATE tbl_insert set name='" . $_POST['name'] . "',foglalas='" . $_POST['foglalas'] . "' WHERE `tbl_insert`.`id` = 1");
    ...
    <div class="container-fluid h-100 bg-light text-dark">
        ...
        <div class="row justify-content-center align-items-center h-100">
            ...
            <h5 class="text-success text-center" id="update"><?=$update;?><h5>
                ...
                <div class="form-group">
                    <select class="form-control" name="foglalas">
                    <?php foreach($foglalas as $rows):?>
                        <option value="<?php echo $rows['foglalas']; ?>"<?php if($row['foglalas'] == $rows['foglalas']) echo 'selected="selected"'; ?>><?php echo $rows['foglalas']; ?></option>
                    <?php endforeach;?>
